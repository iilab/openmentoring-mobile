...
.controller('HomeCtrl', function($scope, $ionicModal, $ionNavBar, $timeout, DBService, $cordovaFile) {
...
.controller('TopicsCtrl', function($scope, $state, $stateParams, $q, $http, $ionicPlatform, $ionicFilterBar, $ionicHistory, $ionicScrollDelegate, $ionicModal, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $cordovaZip, $timeout, DBService) {
